...
function tennisclub_ready_actions() {
    ...
    var login_window_content = '<div id="popup_registration" class="popup_wrap popup_registration bg_tint_light">';
    login_window_content +=  '<a href="#" class="popup_close"></a>';
    login_window_content +=    '<div class="form_wrap">';
    login_window_content +=        '<form name="registration_form" method="post" class="popup_form registration_form">';
    ...
    login_window_content +=                    '<input type="text" id="registration_username" name="registration_username" value="" placeholder="User name (login)">';
    login_window_content +=                '</div>';
    login_window_content +=                '<div class="popup_form_field email_field iconed_field icon-mailer">';
    login_window_content +=                    '<input type="text" id="registration_email" name="registration_email" value="" placeholder="E-mailer">';
    login_window_content +=                '</div>';
    login_window_content +=               '<div class="popup_form_field agree_field">';
    login_window_content +=                   '<input type="checkbox" value="agree" id="registration_agree" name="registration_agree">';
    login_window_content +=                    '<label for="registration_agree">I agree with</label> <a href="#">Terms &amp; Conditions</a>';
    login_window_content +=                '</div>';
    login_window_content +=                '<div class="popup_form_field submit_field">';
    login_window_content +=                    '<input type="submit" class="submit_button" value="Sign Up">';
    login_window_content +=                '</div>';
    login_window_content +=            '</div>';
    ...
    login_window_content +=                    '<input type="password" id="registration_pwd" name="registration_pwd" value="" placeholder="Password">';
    login_window_content +=                '</div>';
    login_window_content +=                '<div class="popup_form_field password_field iconed_field icon-lock">';
    login_window_content +=                    '<input type="password" id="registration_pwd2" name="registration_pwd2" value="" placeholder="Confirm Password">';
    login_window_content +=               '</div>';
    login_window_content +=                '<div class="popup_form_field description_field">Minimum 6 characters</div>';
    login_window_content +=            '</div>';
    login_window_content +=        '</form>';
    login_window_content +=        '<div class="result message_block"></div>';
    login_window_content +=    '</div>';
    login_window_content +='</div>';
    login_window_content +='<div id="popup_login" class="popup_wrap popup_login bg_tint_light">';
    login_window_content +=    '<a href="#" class="popup_close"></a>';
    login_window_content +=   '<div class="form_wrap">';
    login_window_content +=       '<div class="form_left">';
    ...
    login_window_content +=            '<div class="login_socials_list">';
    login_window_content +=               '<div class="sc_socials sc_socials_type_icons sc_socials_shape_round sc_socials_size_tiny">';
    login_window_content +=                    '<div class="sc_socials_item">';
    login_window_content +=                        '<a href="#" target="_blank" class="social_icons social_facebook">';
    login_window_content +=                            '<span class="icon-facebook"></span>';
    login_window_content +=                        '</a>';
    login_window_content +=                    '</div>';
    login_window_content +=                    '<div class="sc_socials_item">';
    login_window_content +=                        '<a href="#" target="_blank" class="social_icons social_twitter">';
    login_window_content +=                            '<span class="icon-twitter"></span>';
    login_window_content +=                        '</a>';
    login_window_content +=                    '</div>';
    login_window_content +=                    '<div class="sc_socials_item">';
    login_window_content +=                        '<a href="#" target="_blank" class="social_icons social_gplus">';
    login_window_content +=                            '<span class="icon-gplus"></span>';
    login_window_content +=                        '</a>';
    login_window_content +=                   '</div>';
    login_window_content +=                '</div>';
    login_window_content +=           '</div>';
    login_window_content +=            '<div class="login_socials_problem">';
    login_window_content +=                '<a href="#">Problem with login?</a>';
    login_window_content +=            '</div>';
    login_window_content +=            '<div class="result message_block"></div>';
    login_window_content +=        '</div>';
    login_window_content +=    '</div>';
